...
<div class="d-flex flex-wrap justify-content-between align-items-start mb-3 gap-2">
    <div>
        ...
        <p class="text-muted mb-0">Resumen de tus ventas y del negocio</p>
    </div>
    <div class="text-muted small text-end">
        <div><i class="fa-regular fa-calendar me-2"></i>{{ $sellerNow->translatedFormat('l, d \\d\\e F \\d\\e Y') }}</div>
        <div><i class="fa-regular fa-clock me-2"></i>{{ $sellerNow->format('h:i a') }}</div>
    </div>
</div>
...
<div class="row g-3 mb-1">
        ...
        <div class="card mw-card mw-kpi-card">
            <div class="card-body d-flex justify-content-between">
                <div>
                    ...
                    <h4 class="mb-0">{{ number_format($sellerMetrics['activeProducts']) }}</h4>
        ...
        <div class="card mw-card mw-kpi-card">
            <div class="card-body d-flex justify-content-between">
                <div>
                    ...
                    <h4 class="mb-0">{{ number_format($sellerMetrics['todayTickets']) }}</h4>
                    <small class="text-muted">tus ventas</small>
                </div>
        ...
        <div class="card mw-card mw-kpi-card">
            <div class="card-body d-flex justify-content-between">
                <div>
                    ...
                    <h4 class="mb-0">${{ number_format($sellerMetrics['todayIncome'], 0, ',', '.') }}</h4>
                    <small class="text-muted">tu total del día</small>
                </div>
    ...
    <div class="col-lg-7">
        <div class="card mw-card">
            ...
            <div class="card-body">
                <canvas id="seller-sales-chart" height="100"></canvas>
            </div>
        </div>
    </div>
    <div class="col-lg-5">
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-md-5 text-center">
                        <canvas id="seller-category-chart" height="150"></canvas>
                    </div>
                    <div class="col-md-7">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const salesChartElement = document.getElementById('seller-sales-chart');
        if (salesChartElement && typeof Chart !== 'undefined') {
            new Chart(salesChartElement, {
                type: 'line',
                data: {
                    labels: @json($sellerChart['labels']),
                    datasets: [{
                        label: 'Ventas',
                        data: @json($sellerChart['series']),
                        borderColor: '#032145',
        ...
        const categoryChartElement = document.getElementById('seller-category-chart');
        if (!categoryChartElement || typeof Chart === 'undefined') return;
